...
const USED = {
  solid: [
    ...
    'chevron-up', 'cloud-sun', 'cloud-sun-rain', 'code', 'cogs', 'comments',
    'copy', 'envelope', 'eye', 'file-alt', 'file-download', 'flask', 'globe',
    'graduation-cap', 'home', 'laptop-code', 'list-ul', 'microphone', 'moon',
    'newspaper', 'project-diagram', 'random', 'robot', 'rss', 'search',
    'shield-alt', 'spinner', 'star', 'sun', 'terminal', 'times', 'user', 'wind',
  ],
